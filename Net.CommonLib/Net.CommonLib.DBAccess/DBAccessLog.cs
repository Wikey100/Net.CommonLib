...
{
    public class DBAccessLog : ILog
    {
        private string logName = "DBAccessLog";

        private static DBAccessLog instance = null;

        public static DBAccessLog Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new DBAccessLog();
                }
                return instance;
            }
        }
