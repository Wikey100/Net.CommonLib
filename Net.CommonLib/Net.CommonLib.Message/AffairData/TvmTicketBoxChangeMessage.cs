...
{
    public class TvmTicketBoxChangeMessage : BaseMessage
    {
        /// <summary>
        /// 交易类型 （2）
        /// </summary>
        ...
        /// 车票补充时间（14）
        /// </summary>
        public string BoxChangeTime { get; set; }
        ...
        public TvmTicketBoxChangeMessage()
        {
            msgType = MsgType.TvmTicketBoxChange;
        }

        public TvmTicketBoxChangeMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.TvmTicketBoxChange;
        }
        ...
        public override void Decode()
        {
            ...
            BoxChangeTime = GetNextString(14);
