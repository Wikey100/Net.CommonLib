...
{
    public class AgmChangeUseModeMessage : BaseMessage
    {
        /// <summary>
        /// 控制命令发送时间CHAR(14)
        /// </summary>
        ...
        public AgmChangeUseModeMessage()
        {
            msgType = MsgType.CmdAgmUseModeChange;
        }

        public AgmChangeUseModeMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.CmdAgmUseModeChange;
        }
