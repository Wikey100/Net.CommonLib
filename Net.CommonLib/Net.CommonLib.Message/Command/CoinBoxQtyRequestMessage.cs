...
{
    public class CoinBoxQtyRequestMessage : BaseMessage
    {
        /// <summary>
        /// 控制命令发送时间CHAR(14)
        /// </summary>
        ...
        public CoinBoxQtyRequestMessage()
        {
            msgType = MsgType.CmdCoinBoxQtyRequest;
        }

        public CoinBoxQtyRequestMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.CmdCoinBoxQtyRequest;
        }
