...
{
    public class NoteBoxQtyRequestMessage : BaseMessage
    {
        /// <summary>
        /// 控制命令发送时间CHAR(14)
        /// </summary>
        ...
        public NoteBoxQtyRequestMessage()
        {
            msgType = MsgType.CmdNoteBoxQtyRequest;
        }

        public NoteBoxQtyRequestMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.CmdNoteBoxQtyRequest;
        }
