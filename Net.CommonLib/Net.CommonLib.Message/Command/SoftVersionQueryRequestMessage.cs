...
{
    public class SoftVersionQueryRequestMessage : BaseMessage
    {
        /// <summary>
        /// 控制命令发送时间CHAR(14)
        /// </summary>
        ...
        public SoftVersionQueryRequestMessage()
        {
            msgType = MsgType.CmdSoftVersionRequest;
        }

        public SoftVersionQueryRequestMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.CmdSoftVersionRequest;
        }
