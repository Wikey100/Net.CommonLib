...
{
    public class SystemOperateModeMessage : BaseMessage
    {
        /// <summary>
        /// 控制命令发送时间CHAR(14)
        /// </summary>
        ...
        public SystemOperateModeMessage()
        {
            msgType = MsgType.CmdSystemOperateMode;
        }

        public SystemOperateModeMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.CmdSystemOperateMode;
        }
