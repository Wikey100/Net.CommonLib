...
{
    public class TikcetBoxChangeMessage : BaseMessage
    {
        /// <summary>
        /// 控制命令发送时间CHAR(14)
        /// </summary>
        ...
        public TikcetBoxChangeMessage()
        {
            msgType = MsgType.CmdTicketBoxChange;
        }

        public TikcetBoxChangeMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.CmdTicketBoxChange;
        }
