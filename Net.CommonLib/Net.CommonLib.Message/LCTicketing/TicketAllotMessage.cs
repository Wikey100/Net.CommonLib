...
namespace Net.CommonLib.Message.LCTicketing
{
    ...
    /// 配发明细
    /// </summary>
    public class TicketAllotDetail
    {
    ...
    /// 车票配发单
    /// </summary>
    public class TicketAllotMessage : BaseMessage
    {
        /// <summary>
        /// 单据编号char(13)
        /// </summary>
        ...
        public TicketAllotMessage()
        {
            msgType = MsgType.TicketAllot;
        }

        public TicketAllotMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.TicketAllot;
        }
