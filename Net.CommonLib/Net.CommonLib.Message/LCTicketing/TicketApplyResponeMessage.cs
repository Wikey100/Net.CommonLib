...
{
    public class TicketApplyResponeMessage : BaseMessage
    {
        /// <summary>
        /// 单据编号char(13)
        /// </summary>
        ...
        public TicketApplyResponeMessage()
        {
            msgType = MsgType.TicketApplyRespone;
        }

        public TicketApplyResponeMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.TicketApplyRespone;
        }
