...
{
    public class CoinBoxQtyResponseMessage : BaseMessage
    {
        /// <summary>
        /// 采集时间CHAR(14)
        /// </summary>
        ...
        public CoinBoxQtyResponseMessage()
        {
            msgType = MsgType.ResponeCoinQtyQuery;
        }

        public CoinBoxQtyResponseMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.ResponeCoinQtyQuery;
        }
