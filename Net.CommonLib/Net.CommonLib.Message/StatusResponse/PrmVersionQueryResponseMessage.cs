...
{
    public class PrmVersionQueryResponseMessage : BaseMessage
    {
        /// <summary>
        /// 时间 CHAR(14)
        /// </summary>
        ...
        public PrmVersionQueryResponseMessage()
        {
            msgType = MsgType.ResponePrmVersion;
        }

        public PrmVersionQueryResponseMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.ResponePrmVersion;
        }
