...
namespace Net.CommonLib.Message
{
    ...
    public class TicketBoxQtyResponseMessage : BaseMessage
    {
        /// <summary>
        /// 采集时间CHAR(14)
        /// </summary>
        ...
        public TicketBoxQtyResponseMessage()
        {
            msgType = MsgType.ResponeTicketQtyQuery;
            // BoxDataRecordList = new List<BoxDataRecord>();
        }

        public TicketBoxQtyResponseMessage(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.ResponeTicketQtyQuery;
            //  BoxDataRecordList = new List<BoxDataRecord>();
        ...
        public override void Encode()
        {
            ...
            foreach (BoxDataRecord ms in BoxDataRecordList)
            {
                ...
                encodeBuf.AddRange(AddString(ms.Count.PadLeft(8, '0'), 8));
            }
        }
    }
}