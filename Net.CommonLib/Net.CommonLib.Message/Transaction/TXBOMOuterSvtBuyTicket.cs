...
namespace Net.CommonLib.Message.Transaction
{
    ...
    /// BOM上SVT购买单程票(外卡)
    /// </summary>
    public class TXBOMOuterSvtBuyTicket : BaseMessage
    {
        /// <summary>
        /// 发生交易设备代码
        /// </summary>
        ...
        public TXBOMOuterSvtBuyTicket()
        {
            msgType = MsgType.TxnBomOuterSvtBuyTicket;
        }

        public TXBOMOuterSvtBuyTicket(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.TxnBomOuterSvtBuyTicket;
        }
