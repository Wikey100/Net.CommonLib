...
namespace Net.CommonLib.Message.Transaction
{
    ...
    /// BOM租卡(单程票发售)
    /// </summary>
    public class TXBOMSjtSale : BaseMessage
    {
        /// <summary>
        /// 发生交易设备代码
        /// </summary>
        ...
        public TXBOMSjtSale()
        {
            msgType = MsgType.TxnBomSjtSale;
        }

        public TXBOMSjtSale(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.TxnBomSjtSale;
        }
        ...
        public override void Encode()
        {
            ...
            encodeBuf.AddRange(AddString(PaymentCardId.PadLeft(16, '0'), 16));
