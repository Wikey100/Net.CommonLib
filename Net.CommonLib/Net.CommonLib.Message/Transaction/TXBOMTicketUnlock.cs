...
namespace Net.CommonLib.Message.Transaction
{
    ...
    public class TXBOMTicketUnlock : BaseMessage
    {
        /// <summary>
        /// 发生交易设备代码
        /// </summary>
        ...
        public TXBOMTicketUnlock()
        {
            msgType = MsgType.TxnBomTicketUnlock;
        }

        public TXBOMTicketUnlock(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.TxnBomTicketUnlock;
        }
        ...
        public override void Encode()
        {
            ...
            encodeBuf.AddRange(AddString(TxTotalaAmt, 8));
