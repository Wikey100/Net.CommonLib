...
namespace Net.CommonLib.Message.Transaction
{
    ...
    /// TVM上SVT（外卡）购单程票
    /// </summary>
    public class TXTVMOuterSvtBuyTicket : BaseMessage
    {
        /// <summary>
        /// 发生交易设备代码
        /// </summary>
        ...
        public TXTVMOuterSvtBuyTicket()
        {
            msgType = MsgType.TxnTvmOuterSvtBuyTicket;
        }

        public TXTVMOuterSvtBuyTicket(byte[] bytes)
            : base(bytes)
        {
            msgType = MsgType.TxnTvmOuterSvtBuyTicket;
        }
