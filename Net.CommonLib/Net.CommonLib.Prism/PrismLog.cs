...
namespace Net.CommonLib.Prism
{
    public class PrismLog : ILog
    {
        private string logName = "PrismLog";

        private static PrismLog instance = null;

        public static PrismLog Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new PrismLog();
                }
                return instance;
            }
        }
